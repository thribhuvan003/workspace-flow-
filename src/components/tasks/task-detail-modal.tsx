            ...
            <div className="px-6 pt-6 pb-4 border-b border-[#1e1e2e]">
              ...
              {titleEditing ? (
                <input
                  ...
                  className="w-full bg-transparent text-xl font-semibold text-white outline-none border-b border-[#ff5c00]/50 pb-1 focus:border-[#ff5c00]"
                  autoFocus
                />
              ) : (
                <h2
                  className="text-xl font-semibold text-white cursor-pointer hover:text-[#ff8a40] transition-colors pr-8 leading-snug"
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="flex items-center gap-1">
                      <Button
                        ...
                        className="h-6 px-2 text-[10px] text-[#ff5c00]/70 hover:text-[#ff5c00] hover:bg-[#ff5c00]/10"
                  ...
                  {descPreview ? (
                    ...
                    <Textarea
                      ...
                      className="min-h-[120px] resize-none bg-[#0d0d14] border-[#2a2a3e] text-white/80 placeholder:text-white/25 focus:border-[#ff5c00]/40"
                    />
                  )}
                </div>
                ...
                <div>
                  ...
                  <div className="flex gap-3 items-end">
                    <Textarea
                      ...
                      className="flex-1 min-h-[72px] resize-none bg-[#0d0d14] border-[#2a2a3e] text-white/80 placeholder:text-white/25 focus:border-[#ff5c00]/40"
                    />
                    <Button
                ...
                <div>
                  ...
                  <input
                    ...
                    className={cn(
                      ...
                      "focus:outline-none focus:ring-2 focus:ring-[#ff5c00]/50 focus:border-[#ff5c00]/50",
                      "[color-scheme:dark]"
                    )}
                  />
                  {task.dueDate && (
