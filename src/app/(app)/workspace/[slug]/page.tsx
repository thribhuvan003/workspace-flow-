...
const COLUMNS: {
  ...
  { id: "TODO",        label: "To Do",       color: "#6b7280", lightColor: "rgba(107,114,128,0.10)" },
  { id: "IN_PROGRESS", label: "In Progress", color: "#6366f1", lightColor: "rgba(99,102,241,0.10)"  },
  { id: "REVIEW",      label: "Review",      color: "#f59e0b", lightColor: "rgba(245,158,11,0.10)"  },
  { id: "DONE",        label: "Done",        color: "#10b981", lightColor: "rgba(16,185,129,0.10)"  },
];
      ...
      {(provided, snapshot) => (
        <div
          ...
          className={cn(
            ...
            snapshot.isDragging
              ? "border-indigo-500/60 shadow-2xl shadow-indigo-500/20 rotate-1 scale-[1.02] bg-[#15151f] z-50"
...
function QuickAddForm({
  ...
  return (
    <div className="rounded-xl border border-indigo-500/40 bg-[#111118] p-2.5 shadow-lg shadow-indigo-500/10">
      <input
        ref={inputRef}
        value={title}
          ...
          <div
            ...
            className={cn(
              ...
              snapshot.isDraggingOver
                ? "bg-indigo-500/5 outline outline-1 outline-dashed outline-indigo-500/30"
                : "bg-transparent"
            )}
          >
